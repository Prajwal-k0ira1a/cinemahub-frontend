...
// Swagger documentation should advertise the hosted backend first, but keep localhost for local testing.

const productionServerUrl = "https://cinemahub-backend.onrender.com";
const configuredServerUrl =
  process.env.OPENAPI_SERVER_URL || process.env.API_BASE_URL || productionServerUrl;
    ...
    servers: [
      {
        ...
        description:
          configuredServerUrl === productionServerUrl
            ? "Hosted backend"
            : "Configured backend",
      },
      {
